...
$message .= '<img alt="" src="http://www.comapny-name.com/static/images/bg.PNG" />';
$message .= '</div>';
...
$message .= '<img alt="" height="80" src="http://www.comapny-name.com/static/images/abcdNewLogo.png" style="float: left; margin-left: 10px;" width="50">';
...
$message .= '&nbsp;&nbsp;Log in to your <a href="http://www.comapny-name.com?utm_source='.$activityutm.'" target="_blank">eZdia account</a>.<br>';
...
$message .= '<br>Thanks and Regards,<br>Maya Ray | Project Support Exceutive | comapny-name';
$message .= '</div>';
$message .= 'If you do not wish to receive further mails, please <a href="http://www.comapny-name.com/jsp/Unsubscribe.jsp?email='.$email. '&id='.sha1($username).'">unsubscribe me </a><br><br>';
$message .= 'If you see any issues with the above link please copy the link on to your browser to unsubscribe  http://www.comapny-name.com/jsp/Unsubscribe.jsp?email='.$email. '&id='.sha1($username).'';
$message .= '</div>';
$message .= '</div>';
$message .= '</body></html>';
$subject = 'Your visibilty is limited to comapny-name and search engine';
?>
